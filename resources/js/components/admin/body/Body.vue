...
<div class="chit-chat-layer1 row">
	<div class="col-md-6 chit-chat-layer1-left row">
      ...
      <div class="col-md-6 chit-chat-layer1-rit">    	
      	  <div class="geo-chart">
				...
				<div class="wrapper-flex">
				    ...
				    <table id="myTable" class="geoChart tableChart data-table col-table myTable chtr-table" style="display: none; position: absolute; top: -99999px; width: 478px;">
   ...
   <div class="main-page-chart-layer1 row">
		<div class="col-md-6 chart-layer1-left"> 
			...
			<div class="span-2c">  
                        ...
                        <canvas id="bar" height="300" width="485" style="width: 485px; height: 300px;"></canvas>
...
<div class="chart-layer-2 row ">
	...
	<div class="col-md-6 chart-layer2-left">
		<div class="content-main revenue">			
					<h3>Total Revenue</h3>
					<canvas id="radar" height="350" width="480" style="width: 480px; height: 350px;"></canvas>
